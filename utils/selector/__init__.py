...
from utils.response.text import TextResponse
from utils.python import flatten, unicode_to_str
...
class XPathSelector(object_ref):
    ...
    def __init__(self, text=None, node=None, parent=None, expr=None):
        if parent:
            self.doc = parent.doc
            self.xmlNode = node
        elif text:
